...
export const PROVENANCE = {
  ...
  // 실제 타임스탬프에서 뽑은 작업 궤적 — 30분 이상 공백을 경계로 끊은 구간.
  // min=구간 길이(분), n=프롬프트 수. 자기 서술이 아니라 로그라 지어내기 어렵다.
  timeline: [
    { d:'07-22', t:'02:18', min:23,  n:4,  k:'GPU 단위 정리',      s:'"1대"가 칩 1장인지 서버 8장인지. 보드(SXM/PCIe) 차이까지' },
    { d:'07-22', t:'04:41', min:59,  n:15, k:'가격·구매루트 확정',  s:'AWS 온디맨드 vs Elice vs 단품 구매. 1장 단위 대여 가능 여부' },
    { d:'07-22', t:'12:57', min:109, n:25, k:'계산기로 전환',       s:'"돌린다"의 정의 재정립 → 격자표를 계산기로. 기업 케이스 매칭은 근거 부족으로 폐기' },
    { d:'07-23', t:'00:15', min:0,   n:1,  k:'라벨 정리',          s:'MoE/Dense 표기가 혼란만 줘서 제거' },
    { d:'07-23', t:'05:16', min:10,  n:3,  k:'로고·정렬 도입',      s:'모델 식별성 확보, 대여/구매 3종 동시 표시' },
    { d:'07-23', t:'06:07', min:0,   n:1,  k:'3박스 레이아웃',      s:'모델·설정 위, 결과 아래로 구조 확정' },
    { d:'07-23', t:'07:16', min:0,   n:1,  k:'렌더 확인',          s:'스크린샷 대조' },
    { d:'07-23', t:'08:07', min:55,  n:8,  k:'리패턴 퀵필터',       s:'실제 요건(툴콜 65+·64K·INT8)을 프리셋으로. Qwen3.8·Granite 편입' },
    { d:'07-23', t:'09:41', min:0,   n:1,  k:'Granite 반영',       s:'모델 표 갱신' },
    { d:'07-26', t:'02:14', min:114, n:33, k:'재설계 + 할루시네이션 4연타', s:'표 재구성·정밀도 근거 확인 후 "한번 더"만 4회 — TFLOPS·KV캐시 오류가 여기서 나옴' },
    { d:'07-26', t:'05:22', min:16,  n:6,  k:'신뢰 등급 도입',      s:'툴콜링 강/중 3단계 → 점수화. "컨설팅에 써도 되냐"는 질문에서 A/B/C/D 체계가 나옴' },
    { d:'07-26', t:'06:32', min:13,  n:7,  k:'FP8 기본화·경고 배치', s:'품질 손실 미미해 기본값으로. "반드시 실측하라"를 최상단에' },
  ],
